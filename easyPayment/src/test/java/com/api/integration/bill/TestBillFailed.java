...
public class TestBillFailed {
    ...
    public void testfindByIdBillFailed(TestInfo testInfo, TestReporter testReporter) throws Exception {
        ...
        // Arrange  ---- Esto significa todo el arranque cargaando los datos q necesita
        ...
        MockHttpServletRequestBuilder requestMock = 
                MockMvcRequestBuilders
                        .get("/bills/findByIdBill")   // url
                        .header("Authorization", "Bearer " + token2) 
                        .param("id", String.valueOf(idClientFake))
                        .contentType(MediaType.APPLICATION_JSON);
        
        // Act --- el act es ejecutar la clase metodo en este caso es la peticion. "mockMvc.perform(requestMock)"
        // los assert son las expectativas ..ejemplo "".andExpect(jsonPath("$.status").value(404))""
